...
range(df$green....matrix.musgo.....2...ncol...1.)

hist(df$green....matrix.musgo.....2...ncol...1., main ="distrib_green all", xlim=c(range(df$green....matrix.musgo.....2...ncol...1.)), xlab = "")

df0 <- subset(df, df$label==1)

hist(df0$green....matrix.musgo.....2...ncol...1., main ="distrib_green guata", xlim=c(range(df$green....matrix.musgo.....2...ncol...1.)), xlab = "")

df1 <- subset(df, df$label==2)

hist(df1$green....matrix.musgo.....2...ncol...1., main ="distrib_green musgo", xlim=c(range(df$green....matrix.musgo.....2...ncol...1.)), xlab = "")

hist( df1$green....matrix.musgo.....2...ncol...1., col=rgb(1,0,0,1/4), xlim=c(0,0.6), ylim=)  # first histogram
hist( df0$green....matrix.musgo.....2...ncol...1., col=rgb(0,0,1,1/4), xlim=c(0,0.6), add=T)  # second
