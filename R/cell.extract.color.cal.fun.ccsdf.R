...
cell.extract.color.cal.fun <- 
  ...
  chart_vals <- data.frame(red.chart = c(0.17, 0.63, 0.15, 
                                         ...
                                         0.08, 0.03), green.chart = c(0.1, 0.32, 0.19, 0.14, 0.22, 
                                                                      0.47, 0.27, 0.11, 0.13, 0.06, 0.48, 0.4, 0.06, 0.27, 
                                                                      0.07, 0.62, 0.13, 0.22, 0.95, 0.62, 0.38, 0.2, 0.09, 
                                                                      0.03), blue.chart = c(0.07, 0.24, 0.34, 0.06, 0.42, 0.42, 
  ...
  red_mat <- raster::raster(as.matrix(crop(red_mat, extent(obs_ext))))
  ...
  green_mat <- raster::raster(as.matrix(crop(green_mat, extent(obs_ext))))
  ...
  blue_mat <- raster::raster(as.matrix(crop(blue_mat, extent(obs_ext))))
  ...
  nir_mat <- raster::raster(as.matrix(crop(nir_mat, extent(obs_ext))))
